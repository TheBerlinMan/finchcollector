...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'finch-collector-tommyo.fly.dev']

CSRF_TRUSTED_ORIGINS = ['https://finch-collector-tommyo.fly.dev']
...
LOGIN_REDIRECT_URL = 'stuff-index'
